...
import me.t3sl4.factory.util.hologram.api.MckHologram;
...
public final class Holograms implements Listener {
   ...
   public void reloadHolograms() {
      ...
      while(var2.hasNext()) {
         ...
         Location location = (new LocationOf((String)this.yaml.getString("Holograms." + id + ".me.t3sl4.factory.util.location").orElse(""))).value();
