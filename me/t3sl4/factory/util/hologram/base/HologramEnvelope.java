package me.t3sl4.factory.util.hologram.base;

import me.t3sl4.factory.util.hologram.api.Hologram;
import me.t3sl4.factory.util.hologram.api.IHologram;
import me.t3sl4.factory.util.hologram.api.MckNMSHologram;
import me.t3sl4.factory.util.hologram.nms.v1_10_R1.Hologram1_10_R1;
import me.t3sl4.factory.util.hologram.nms.v1_11_R1.Hologram1_11_R1;
import me.t3sl4.factory.util.hologram.nms.v1_12_R1.Hologram1_12_R1;
import me.t3sl4.factory.util.hologram.nms.v1_13_R1.Hologram1_13_R1;
import me.t3sl4.factory.util.hologram.nms.v1_13_R2.Hologram1_13_R2;
import me.t3sl4.factory.util.hologram.nms.v1_14_R1.Hologram1_14_R1;
import me.t3sl4.factory.util.hologram.nms.v1_8_R1.Hologram1_8_R1;
import me.t3sl4.factory.util.hologram.nms.v1_8_R2.Hologram1_8_R2;
import me.t3sl4.factory.util.hologram.nms.v1_8_R3.Hologram1_8_R3;
import me.t3sl4.factory.util.hologram.nms.v1_9_R1.Hologram1_9_R1;
import me.t3sl4.factory.util.hologram.nms.v1_9_R2.Hologram1_9_R2;
import me.t3sl4.factory.util.itemstack.util.Colored;
import me.t3sl4.factory.util.location.StringOf;
import me.t3sl4.factory.util.mcyaml.IYaml;
import me.t3sl4.factory.util.versionmatched.VersionMatched;
...
public class HologramEnvelope implements Hologram {
   ...
   public void save(@NotNull IYaml file, @NotNull UUID uuid) {
      file.set("Holograms." + uuid.toString() + ".me.t3sl4.factory.util.location", (new StringOf(this.location)).asString());
