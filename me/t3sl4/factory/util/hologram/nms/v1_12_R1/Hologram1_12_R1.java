package me.t3sl4.factory.util.hologram.nms.v1_12_R1;
...
public class Hologram1_12_R1 implements IHologram {
   ...
   public void configureHologram(@NotNull Object entity, @NotNull String text, @NotNull Location location) {
      ...
      nmsEntity.setCustomName(((IChatBaseComponent)Objects.requireNonNull(ChatSerializer.a("{\"text\": \"" + text + "\"}"))).getText());
